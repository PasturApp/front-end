...
<nav>
  <a class="logo" href="/"
    ><img src="/icons/pasturapp-logo.png" alt="PasturApp logo" /><span
      >PasturApp</span
    ></a
  >
  <ul>
...
<header>
  <div>
    <h1 class="heading">
      Uniendo tradición y tecnología para una producción <span id="words" />
    </h1>
  </div>
  <a class="swipe" href="#product"
    ><img src="/icons/swipe-arrow.png" alt="swipe arrow" /></a
  >
</header>
...
<style lang="postcss">
  ...
  .heading {
    @apply text-xl md:text-5xl lg:text-6xl;
    color: var(--white-background);
  }
